...
$url        = 'https://cdn.unrealengine.com/CrossToolchain_Linux/v22_clang-16.0.6-centos7.exe'
...
$packageArgs = @{
  ...
  checksum      = '1eeeec120484c7c7fc3487a6f71695e3f41184171d48bc1f43440a4a90dd2516'
  checksumType  = 'sha256'
